...
if(BUILD_TESTING)
    ...
    set_tests_properties(linux-defragger-affs-native-python PROPERTIES
        ENVIRONMENT
            "PYTHONDONTWRITEBYTECODE=1;PYTHONPATH=${CMAKE_CURRENT_SOURCE_DIR}/gui:${CMAKE_CURRENT_SOURCE_DIR}/tests;LINUX_DEFRAGGER_BUILD_DIR=${CMAKE_CURRENT_BINARY_DIR};LINUX_DEFRAGGER_ENABLE_UNAUDITED_WRITES=I_ACCEPT_UNAUDITED_RAW_WRITES")
