...
if(BUILD_TESTING)
    ...
    add_test(
        NAME linux-defragger-gui-ext-display-identity
        COMMAND "${LD_PYTHON3_EXECUTABLE}"
                "${CMAKE_CURRENT_SOURCE_DIR}/tests/test_ext_display_identity.py")
    add_test(
    ...
    set_tests_properties(
        ...
        PROPERTIES
        ENVIRONMENT
            "PYTHONDONTWRITEBYTECODE=1;PYTHONPATH=${CMAKE_CURRENT_SOURCE_DIR}/gui;LINUX_DEFRAGGER_ENABLE_UNAUDITED_WRITES=I_ACCEPT_UNAUDITED_RAW_WRITES")
endif()
