...
def main() -> None:
    ...
    common_contract = (
        ('COMMON_TAG="v1.16.0"', 'INFILTRATR_COMMON_TAG "v1.16.0"'),
        ('COMMON_VERSION="1.16.0"', 'INFILTRATR_COMMON_EXPECTED_VERSION "1.16.0"'),
        (
            'COMMON_COMMIT="a9db06b11f493c4e6f42bf6c13cc5cc5c73e1fc4"',
    ...
    assert "Infiltratr Common 1.16.0" in design
    assert "a9db06b11f493c4e6f42bf6c13cc5cc5c73e1fc4" in design
