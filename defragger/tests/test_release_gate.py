...
def main() -> None:
    ...
    common_contract = (
        ('COMMON_TAG="v1.18.0"', 'INFILTRATR_COMMON_TAG "v1.18.0"'),
        ('COMMON_VERSION="1.18.0"', 'INFILTRATR_COMMON_EXPECTED_VERSION "1.18.0"'),
        (
            'COMMON_COMMIT="0f458a7145f3a996ff19f11bf9d0893b91ae5cbb"',
            '0f458a7145f3a996ff19f11bf9d0893b91ae5cbb',
        ),
    )
    ...
    assert "Infiltratr Common 1.18.0" in design
    assert "0f458a7145f3a996ff19f11bf9d0893b91ae5cbb" in design
