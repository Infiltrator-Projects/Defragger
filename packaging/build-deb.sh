...
INSTALLED_SIZE=$(du -sk "$STAGE/root/usr" | awk '{print $1}')
{
    ...
    printf 'Depends: python3, python3-gi, python3-cairo, gir1.2-gtk-3.0, policykit-1, udisks2, util-linux, libext2fs2, libsqlite3-0, libssl3t64\n'
    ...
    printf ' and HFS+/HFSX filesystems. Btrfs, classic HFS, APFS, Minix, UFS and ZFS\n'
    printf ' remain analysis-only.\n'
    printf ' %s\n' "$FLAVOR_DESCRIPTION"
